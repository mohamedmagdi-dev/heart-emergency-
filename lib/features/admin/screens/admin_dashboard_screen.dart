...
//   }
//
//   Widget _buildStatCard(String value, String label, IconData icon, Color color, Color backgroundColor) {
//     return Container(
//       padding: const EdgeInsets.all(20),
//       decoration: BoxDecoration(
...
//                 padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
//                 decoration: BoxDecoration(
//                   color: rating.role == 'doctor' ? Colors.blue.withOpacity(0.1) : Colors.green.withOpacity(0.1),
//                   borderRadius: BorderRadius.circular(8),
//                 ),
//                 child: Text(
//                   rating.role == 'doctor' ? 'تقييم طبيب' : 'تقييم مريض',
//                   style: TextStyle(
//                     color: rating.role == 'doctor' ? Colors.blue[700] : Colors.green[700],
//                     fontSize: 12,
//                     fontWeight: FontWeight.w600,
//                   ),
//                 ),
...
class _AdminDashboardScreenState extends ConsumerState<AdminDashboardScreen>
  ...
  Widget _buildRatingStatCard(String value, String label, IconData icon, Color color, Color backgroundColor) {
    return Container(
      padding: const EdgeInsets.all(20),
      decoration: BoxDecoration(
        color: backgroundColor,
