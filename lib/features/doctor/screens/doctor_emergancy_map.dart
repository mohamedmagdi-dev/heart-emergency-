...
//     // High accuracy stream with sensible distance filter to reduce API calls
...
//         position.longitude,
//       );
//       // Only refresh route if moved sufficiently to affect polyline
//       if (movedDistance >= 10) {
//         setState(() {}); // Update marker position
//         _getRoute();
//       }
//     });
//   }
//
//   Future<void> _loadDoctorCurrency() async {
//     try {
//       // Using Riverpod currentUserDataProvider to get UserModel
//       // We don't have ref in State, so use WidgetsBinding to access context later in build via Consumer.
//       // As a simple approach, we will derive currency from FirebaseAuth current user via FirestoreService if needed.
//       // However to avoid logic changes, we will keep a label updated in build using Consumer.
//     } catch (_) {}
//   }
//
